...
Future main() async {
  ...
  runApp(RotaHistorica());
}

class RotaHistorica extends StatefulWidget {
  @override
  _RotaHistoricaState createState() => _RotaHistoricaState();
}

class _RotaHistoricaState extends State<RotaHistorica> {
...
index:1,                                text: '   A fábrica de Tabacos da Maia, fundada em 1971 por Manuel Bento Sousa, laborou até 1988, permanecendo as memórias dos processos técnicos da produção agrária e industrial do tabaco. Este museu contribuiu para a preservação da memória histórica, social e cultural do tabaco, que apesar de ser uma fábrica familiar, foi considerado o maior espaço de trabalho da freguesia da Maia. Integra recursos de património que podem ser contemplados através da sala de pesagem e prensagem, secador de lume direto e indireto, ponte-báscula e plantações de tabaco. ',
                              ),
                            ),
                          ),
                        },
